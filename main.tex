...
\homepage{fahri.id}{https://fahri.id} % The first argument is %the url for the clickable link, the second argument is the url displayed in the %template - this allows special characters to be displayed such as the tilde in this %example
...
\cventry{July 2019--Current}{Senior Software Engineer}{Tiket.Com - One of the best online travel booking website based in Indonesia}{}{}
{
\begin{itemize}
...
\section{Blog}
\cvitem{English}{\url{https://fahri.id/}}
\cvitem{Bahasa}{\url{https://fahri.id/id/}}
...
\begin{itemize}
      ...
      \item \url{https://www.reddit.com/r/programming}
 \end{itemize}
}
%----------------------------------------------------------------------------------------
%	COVER LETTER
